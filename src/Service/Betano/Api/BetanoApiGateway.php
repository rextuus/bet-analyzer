...
class BetanoApiGateway
{
    ...
    public function getNextDailyMatchEvents(): DailyMatchEventResponse
    {
        ...
        $client = $this->clientFactory->createClient($header, self::SEARCH_API_URI);

        $response = $client->request('GET');dd($response);
